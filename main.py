...
if game_type == 3:
    ...
    record_deck(player_dumy,'三人斗地主预留牌.txt')
if game_type == 4:
    deal_to_multi_players_remain(deck,8,player_dumy,player_a,player_b,player_c,player_d)
    ...
    record_deck(player_dumy,'四人斗地主预留牌.txt')
